...
files_reviewed_list:
  ...
  - basicctrl/demo/__init__.py
  - basicctrl/demo/calculator_click.py
  - basicctrl/log.py
  ...
  - basicctrl/state/fingerprint.py
  - basicctrl/state/graph.py
  - basicctrl/state/ring_buffer.py
  - basicctrl/state/snapshot.py
  - basicctrl/verifier/__init__.py
  - basicctrl/verifier/aggregator.py
  - basicctrl/verifier/axobserver.py
  - basicctrl/verifier/distnotif.py
  - basicctrl/verifier/ensemble/__init__.py
  - basicctrl/verifier/ensemble/l0_push.py
  - basicctrl/verifier/ensemble/l1_cheap.py
  - basicctrl/verifier/ensemble/l2_medium.py
  - basicctrl/verifier/ensemble/l3_llm.py
  - basicctrl/verifier/ensemble/weighted_vote.py
  - basicctrl/verifier/kqueue_proc.py
  - basicctrl/verifier/nsworkspace.py
  - scripts/doctor.py
...
**File:** `basicctrl/ax/observer.py:255-307`
...
**File:** `basicctrl/mcp_server/healing_tools.py:94-103`
...
**File:** `basicctrl/ax/observer.py:108-112,247-248,307`
...
**File:** `basicctrl/ax/observer.py:256-274`
...
**File:** `basicctrl/persist/durable_step.py:161-169`
...
**File:** `basicctrl/verifier/kqueue_proc.py:47`
...
**File:** `basicctrl/ax/observer.py:247-248`
...
**File:** `basicctrl/ax/observer.py:300`
...
**File:** `basicctrl/profile/capability_probe.py:98,149`, `basicctrl/profile/classifier.py:97`
...
**File:** `basicctrl/verifier/nsworkspace.py:97`
...
**File:** `basicctrl/mcp_server/proxy.py:67`
...
**File:** `basicctrl/mcp_server/proxy.py:73-104`
...
**File:** `basicctrl/mcp_server/proxy.py:194`
...
**File:** `basicctrl/ax/walker.py:205-219`, `basicctrl/demo/calculator_click.py:280-315`
...
**Fix:** Promote the demo's combined version (try AXValueGetValue first, fall back to plain tuple) into `walker.py` and import it from the demo. Move the helper to `basicctrl.ax.coords` if a shared module makes more sense.

### IN-09: Walker `max_depth=3` semantics are off-by-one vs docstring

**File:** `basicctrl/ax/walker.py:1-7,130`
...
**File:** `basicctrl/persist/session_writer.py:73-75`
...
**File:** `basicctrl/state/fingerprint.py:38-39`
...
**File:** `basicctrl/state/graph.py:139-173`
...
**File:** `basicctrl/ax/errors.py:123-130`
...
**File:** `basicctrl/ax/walker.py:31`
