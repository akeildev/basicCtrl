...
- `cua_overlay/actions/channel_registry.py` contains literal `CHANNEL_TO_TIER_DEFAULT`
- `grep 'def tier_for_channel' cua_overlay/actions/channel_registry.py` returns 1 match
