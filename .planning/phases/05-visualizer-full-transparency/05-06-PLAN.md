...
depends_on: [01, 04]
files_modified:
  - cua_overlay/replay/engine.py
  - cua_overlay/replay/timeline.py
autonomous: true
...
<task type="auto">
  ...
  <files>cua_overlay/replay/engine.py</files>
  <read_first>
    - RESEARCH.md §"Replay Engine" L123-136 (StateNode reconstruction, frame mapping)
  </read_first>
  <action>
Create cua_overlay/replay/engine.py for deterministic state reconstruction:
...
<task type="auto">
  ...
  <files>cua_overlay/replay/timeline.py</files>
  <read_first>
    - RESEARCH.md §"3D Timeline Rendering" L94-112 (isometric projection, Canvas rendering)
  </read_first>
  <action>
Create cua_overlay/replay/timeline.py for 3D timeline data model + projection:
